...
base_url='http://www.iryo.pref.chiba.lg.jp/kensaku/SimpleSearch.aspx?sy=m'
WAIT_SEC=20
...
def start_driver():
    ...
    try:
        ...
        try:
            driver = webdriver.Chrome(service=Service(f'C:\\Users\\{USERNAME}\\.wdm\\drivers\\chromedriver\\win64\\116.0.5845.179\\chromedriver.exe'), options=options)
        except:
