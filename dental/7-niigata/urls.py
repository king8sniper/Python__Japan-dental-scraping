...
base_url = 'http://qq.niigata-iyaku.jp/'
search_base_url = 'http://qq.niigata-iyaku.jp/qq15/qqport/kenmintop/'
...
def main():
    ...
    time.sleep(3)
    element = driver.find_element(By.XPATH, '//h3[@id="h3_4" and @onclick="opnCls(4);"]')
    element.click()
    time.sleep(3)

    checkbox1 = driver.find_element(By.XPATH, '//input[@type="checkbox" and @name="kamoku[]" and @value="z1" and @id="kamoku1" and @class="big"]')
    checkbox2 = driver.find_element(By.XPATH, '//input[@type="checkbox" and @name="kamoku[]" and @value="z3" and @id="kamoku3" and @class="big"]')
    checkbox1.click()
    time.sleep(1)
    checkbox2.click()
    time.sleep(1)
