...
def get_actual_data(html):
    ...
    if len(html.find_elements(By.ID, "pnlGairaiKanjyasu")) > 0 and len(html.find_elements(By.ID, "tblGairaiKanjyasu")) > 0:
        general_trs = html.find_element(By.ID, "pnlGairaiKanjyasu").find_element(By.XPATH, 'table[@id="tblGairaiKanjyasu"]').find_elements(By.TAG_NAME, 'tr')
        if len(general_trs) == 1:
            ...
            actualData['day_patients'] = html.find_element(By.ID, "pnlGairaiKanjyasu").find_element(
                By.XPATH, 'table[@id="tblGairaiKanjyasu"]').find_elements(By.TAG_NAME, 'tr')[-2].find_elements(By.TAG_NAME, 'td')[-2].text
    else:
